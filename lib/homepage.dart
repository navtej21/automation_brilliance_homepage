...
import 'package:automation_brilliance_homepage/SmartScreen.dart';
...
class _HomeState extends State<Home> {
  int currentIndex = 0;
  List<Widget> widgets = [HomeScreen(), VoiceScreen(), smart()];
  List<String> screen = ["home", "voice", "smart"];
  List mySmartDevices = [
    ["Fan", "lib/uimage/fan.png"],
    ["Light", "lib/uimage/light-bulb.png"],
    ["TV", "lib/uimage/smart-tv.png"],
    ["AC", "lib/uimage/air-conditioner.png"]
  ];
